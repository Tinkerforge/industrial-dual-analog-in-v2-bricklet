...
// --- Basic defines ---
#define BOOTLOADER_DEVICE_IDENTIFIER   2121
#define BOOTLOADER_HW_VERSION_MAJOR    1
#define BOOTLOADER_HW_VERSION_MINOR    0
#define BOOTLOADER_HW_VERSION_REVISION 0

#define BOOTLOADER_STATUS_LED_PIN      P0_0
#define BOOTLOADER_BOOT_PAD_PIN        P2_10
...
#define SPITFP_SELECT_PIN           P0_9
#define SPITFP_SELECT_INPUT         XMC_USIC_CH_INPUT_DX2
#define SPITFP_SELECT_SOURCE        0b001 // DX2B

#define SPITFP_MOSI_PIN             P1_2
#define SPITFP_MOSI_INPUT           XMC_USIC_CH_INPUT_DX0
#define SPITFP_MOSI_SOURCE          0b001 // DX0B

#define SPITFP_MISO_PIN             P0_7
#define SPITFP_MISO_PIN_AF          (XMC_GPIO_MODE_OUTPUT_PUSH_PULL_ALT7 | P0_7_AF_U0C1_DOUT0)
